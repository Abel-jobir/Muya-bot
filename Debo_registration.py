...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
     await update.message.reply_text("                              🎉 *Welcome to Muya Bot!* \n                              🎉 *እንኳን ወደ ሙያ ቦት በሰላም መጡ* \n \n📌  this bot is used to registor any Ethiopian professionals who are interested to find new job opportunities from thier nighbour to thier city. \n \n 📌  some of the information you give to this bot will be given to people that want your contact to make you work for them \n  \n \n📌  ይህ ቦት የሙያ ባለቤት የሆኑ ማንኛውም  ኢትይጵያውያንን የምንመዘግብበትና ባቅርያብያቸው ያሉ የስራ እድሎችን እንዲያገኙ ከባለሙያ ፈላጊዎች ጋር በቀላሉ እንዲገናኙ የምናደርግበት ነው። \n " \
         " \n📌  በዚህ ቦት ላይ የሚያጋሯቸው አንዳንድ መርጃዎችዎ ስራ ሊያሰሯችሁችሁ ለሚፈልጉ ሰዎች ይጋራሉ።\n *please use the below menu to continue* \n \n *ለመቀጠል ከስር ካሉት አማራጮች አንዱን ይጫኑ።* \n \n ስለአሰራራችን የበለጠ ለማውቅ ወይም የትኛውም ጥይቄ ካልዎት ይህንን ይጫኑ", reply_markup=main_menu_markup, parse_mode="Markdown")
